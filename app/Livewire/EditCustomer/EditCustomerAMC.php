...
class EditCustomerAMC extends Component
{
    public $amc;
    ...
    public function mount($customer)
    {
        $this->fill($customer->only([
            'amc', 'amc_from_date', 'amc_to_date', 'amc_renewal_date', 'no_of_visits', 'amc_amount', 'amc_last_year_amount'
        ]));
    }
    ...
    {
        return view('livewire.edit-customer.edit-customer-amc');
    }
}
