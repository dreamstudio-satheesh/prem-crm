...
<div>
    <div class="card">
        ...
        <div class="card-body">
            <form id="online-call-form" action="{{ route('onsite-visits.update', $visit->id) }}" method="POST">
                @csrf
                @method('POST')
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3" id="follow-up-date-wrapper" style="display: none;">
                        ...
                        <input type="date" id="follow_up_date" name="follow_up_date" class="form-control" value="{{ $visit->follow_up_date ? \Carbon\Carbon::parse($visit->follow_up_date)->format('Y-m-d') : '' }}">
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#status_of_call').on('change', function() {
            ...
            $('#call_type').val(selectedStatus === 'online_call' ? 'online_call' : 'onsite_visit');
