                ...
                <div class="card-header">
                    <div class="row" style="padding-top: 20px; padding-left:20px;">
                        ...
                        <div class="col-md-4 text-right">
                            <input wire:model.debounce.300ms="search" id="search-box" type="text" class="form-control" placeholder="Search Roles...">
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div style="padding-top: 10px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button x-data="{ unitId: {{ $role->id }} }" @click="confirmDeletion(unitId)" class="btn btn-danger btn-sm">Delete</button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div>{{ $roles->links() }}</div>
                            <div class="text-right">Total: {{ $roles->total() }}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-4 col-xs-12">
            <div class="card" style="height: 80vh; overflow-y: auto;">
                <div class="card-header card-header-border-bottom d-flex justify-content-between">
                    <h5>{{ $role_id ? 'Edit Role' : 'Create Role' }}</h5>
                </div>
                <div class="card-body" style="padding-top: 10px">
                    <form wire:submit.prevent="store">
                        <div class="form-group">
                            <label for="name">Name*</label>
                            <input type="text" class="form-control" id="name" autofocus placeholder="Enter role name" wire:model="name">
                            @error('name')
