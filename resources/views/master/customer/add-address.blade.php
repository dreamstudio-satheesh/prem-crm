...
<div class="row">
    ...
    <div class="card" id="customerList">
      ...
      <div class="col-md-12 col-lg-10">
        <div class="card" style="height: 80vh; overflow-y: auto;">
          ...
          <form action="{{ route('customers.saveAddress') }}" name="registration" method="post" onkeydown="return event.key != 'Enter';" class="form-horizontal form-bordered">
            <div class="form-body">
              <br>
              ...
              <div style="margin-left: 0px;" class="form-group row">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" id="customer_name" name="customer_name" readonly value='{{$customer->customer_name}}'>

                  <input type="hidden" class="form-control" id="customer_code" name="customer_code" value='{{$customer->customer_id}}'>
                ...
                <table border="1" class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <th> <INPUT class="form-control" type='text' readonly id='sno_1' value='1' size='4' readonly name='sno[]' /> </th>
                      ...
                      <td>
                        <input type="text" value="" name="contactperson[]" id="contactperson_1" class="form-control" autocomplete="off">
                      </td>

                      <td>
                        <input type="text" value="" name="mobileno[]" id="mobileno_1" class="form-control" autocomplete="off">
                      </td>
  ...
  <script>
    function updateitems(para) {
      ...
      $.ajax({
        url: "{{ route('customers.fetchAddressTypes') }}",
        method: "GET",
        data: {
          _token: _token
        },
